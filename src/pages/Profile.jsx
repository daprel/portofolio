      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            {/* Experience 1 */}
            <motion.div variants={item} className="card-glass p-6 flex flex-col md:flex-row gap-6">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  <span className="text-accent font-semibold bg-white px-2 py-0.5 rounded text-sm shadow-sm">PT Perkebunan Nusantara I Regional 2</span>
                  <span className="text-accent font-semibold bg-white px-2 py-0.5 rounded text-sm shadow-sm">Bandung</span>
                  <span className="text-accent font-semibold bg-white px-2 py-0.5 rounded text-sm shadow-sm">Jun 2025 - Aug 2025</span>
                </div>
            ...
            <motion.div variants={item} className="card-glass p-6 flex flex-col md:flex-row gap-6">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  <span className="text-accent font-semibold bg-white px-2 py-0.5 rounded text-sm shadow-sm">PT Perkebunan Nusantara I Regional 2</span>
                  <span className="text-accent font-semibold bg-white px-2 py-0.5 rounded text-sm shadow-sm">Jakarta</span>
                  <span className="text-accent font-semibold bg-white px-2 py-0.5 rounded text-sm shadow-sm">Jun 2025 - Aug 2025</span>
                </div>
                <ul className="list-disc list-inside text-white/80 space-y-1">
            ...
            <motion.div variants={item} className="card-glass p-6 flex flex-col md:flex-row gap-6">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  <span className="text-accent font-semibold bg-white px-2 py-0.5 rounded text-sm shadow-sm">Laboratorium Gambar Teknik Telkom University</span>
                  <span className="text-accent font-semibold bg-white px-2 py-0.5 rounded text-sm shadow-sm">Bandung</span>
                  <span className="text-accent font-semibold bg-white px-2 py-0.5 rounded text-sm shadow-sm">Aug 2023 - Jul 2025</span>
                </div>
                <ul className="list-disc list-inside text-white/80 space-y-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={container}>
            ...
            <motion.div variants={item} className="card-glass p-6 flex gap-4">
              <img
                src={`${basePath}img/logo_telu.png`}
                alt="Logo Tel-U"
          ...
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={container}>
            ...
            <motion.div variants={item} className="card-glass p-6 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={container}>
            ...
            <ul className="space-y-4">
              <motion.li variants={item} className="card-glass p-4">
